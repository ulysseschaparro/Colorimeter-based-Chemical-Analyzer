...
void initRgb()
{
    ...
    // RED   on M0PWM2 (PB4), M0PWM1a //PWM0 generator 1a
    // GREEN on M1PWM2 (PA6), M1PWM1a //PWM1 generator 1a
    // BLUE  on M1PWM3 (PA7), M1PWM1b //PWM1 generator 1b
    ...
    PWM1_1_GENA_R = PWM_1_GENA_ACTCMPAD_ONE | PWM_1_GENA_ACTLOAD_ZERO; //output 2 on PWM1, gen 1a, cmpa
    PWM1_1_GENB_R = PWM_1_GENB_ACTCMPBD_ONE | PWM_1_GENB_ACTLOAD_ZERO; //output 3 on PWM1, gen 1b, cmpb

    PWM1_1_LOAD_R = 1950;                            // set frequency to 40 MHz sys clock / 2 / 1024 = 19.53125 kHz
    PWM0_1_LOAD_R = 1950;
    ...
    PWM0_1_CTL_R = PWM_0_CTL_ENABLE;                 // turn-on PWM1 generator 1
